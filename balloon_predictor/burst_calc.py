...
class BalloonEnum(Enum):
    K50 = Balloon("K50", 0.88, 0.25)
    K100 = Balloon("K100", 1.96, 0.25)
    K150 = Balloon("K150", 2.52, 0.25)
    ...
    K1600 = Balloon("K1600", 9.71, 0.25)
    K1800 = Balloon("K1800", 9.98, 0.25)
    K2000 = Balloon("K2000", 10.54, 0.25)
    K3000 = Balloon("K3000", 13.00, 0.25)
    K4000 = Balloon("K4000", 15.06, 0.25)
    H100 = Balloon("H100", 2.00, 0.25, False)
    H200 = Balloon("H200", 2.97, 0.25)
    H300 = Balloon("H300", 4.30, 0.25, False)
    H350 = Balloon("H350", 4.80, 0.25)
    H500 = Balloon("H500", 5.80, 0.25, False)
    H600 = Balloon("H600", 6.50, 0.30)
    H750 = Balloon("H750", 6.90, 0.30, False)
    H800 = Balloon("H800", 7.00, 0.30)
    H1000 = Balloon("H1000", 8.00, 0.30)
    H1200 = Balloon("H1200", 9.10, 0.25, False)
    H1600 = Balloon("H1600", 10.00, 0.25, False)
    H2000 = Balloon("H2000", 11.00, 0.25, False)
    H3000 = Balloon("H3000", 12.00, 0.25, False)
